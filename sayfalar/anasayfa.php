        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-9">
                <input type="text" name="adsoyad" class="form-control" placeholder="Ad Soyad:" autocapitalize="off" required>
              </div>
            </div>
            <div class="form-group row">
              <label class="col-3 col-form-label">Telefon</label>
              <div class="col-9">
                <input type="text" name="telefon" class="form-control" placeholder="Telefon Numaranız:" autocapitalize="off" required>
              </div>
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <button id="RandevuAl" type="submit" name="RandevuAl" class="btn btn-block btn-success btn-round">
                <i class="fa fa-check-circle"></i> Randevu Oluştur !
              </button>
